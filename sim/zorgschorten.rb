...
graph("Zorgschorten") do 
  ...
  event :e_out_use, "Use (Discard)" do 
    schedule :cron => "*/1", :amount => "10-40" do
  ...
  event :e_laundry, "Work (do laundry)" do
    schedule :on => :e_transfer_pickup, :with_delay => "1d" do
  ...
  event :e_transfer_clean, "Transfer" do 
    schedule :on => :e_laundry, :with_delay => "0-2d"  do
  ...
  event :e_inspect, "Modify (QI)" do 
    schedule :on => :e_transfer_clean, :with_delay => "0-3d" do
  ...
  event :e_transfer_delivery, "Transfer (Delivery)" do 
    schedule :cron => "*/1", :amount => "1-10" do
